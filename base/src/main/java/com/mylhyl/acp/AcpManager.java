...
class AcpManager {
    ...
    private synchronized void showDeniedDialog(final List<String> permissions) {
        ...
        TextView alertdialogrightbtn = (TextView) dialog.findViewById(R.id.alert_dialog_right_btn);
        TextView alertdialogleftbtn = (TextView) dialog.findViewById(R.id.alert_dialog_left_btn);
        TextView dialogtitle = (TextView) dialog.findViewById(R.id.dialog_title);
        alertdialogrightbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startSetting();
            }
        });
        alertdialogleftbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mCallback != null)
        ...
        dialogtitle.setText(mOptions.getDeniedMessage());
